...
class ThursdayFragment : Fragment(), ScheduleItemClickListener {
    private var arrScheduleThursday = ArrayList<ScheduleModel>()
    ...
    override fun onCreateView(
        ...
        arrScheduleThursday = FragmentArrays.arrScheduleThursday
        ...
        floatingActionButton.setOnClickListener {
            ...
            addSchedule.setOnClickListener {
                ...
                if (lectureName != "") {
                    arrScheduleThursday.add(ScheduleModel(scheduleID, "thursday", lectureName, timeName))
